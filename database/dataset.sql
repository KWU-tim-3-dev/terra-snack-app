...
(1, 'Admin', 'admin@example.com', '081234567890', 'admin', 'password', NOW(), NOW()),
(2, 'David', 'david@example.com', '085604733012', 'customer', 'password', NOW(), NOW()),
(3, 'Adit', 'adit@example.com', '08111222333', 'customer', 'password', NOW(), NOW()),
(4, 'Rina', 'rina@example.com', '08133445566', 'customer', 'password', NOW(), NOW()),
(5, 'Dewi', 'dewi@example.com', '082233445566', 'customer', 'password', NOW(), NOW()),
(6, 'Rafli', 'rafli@example.com', '089999111222', 'customer', 'password', NOW(), NOW()),
(7, 'Bima', 'bima@example.com', '087788899900', 'customer', 'password', NOW(), NOW()),
(8, 'Lia', 'lia@example.com', '085500112233', 'customer', 'password', NOW(), NOW()),
(9, 'Hana', 'hana@example.com', '082244556677', 'customer', 'password', NOW(), NOW()),
(10, 'Tono', 'tono@example.com', '085533322211', 'customer', 'password', NOW(), NOW()),
(11, 'Gilang', 'gilang@example.com', '081355577799', 'customer', 'password', NOW(), NOW());
